...
var OneStepCheckoutLoginPopup = Class.create({
    initialize: function(options) {
        ...
        this.coupon_alert = $('onestepcheckout-coupon-alert');
        this.registeration_box = $('onestepcheckout-register-link');
    ...
    bindEventHandlers: function() {
        ...
        if(this.coupon_alert)
        {
            this.coupon_alert.observe('click', function(e) {
                e.preventDefault();
                this.forgot_password_container.hide();
                this.login_container.show();
                this.registeration_box.show();
                this.popup.open();
                this.mode = 'login';
            }.bind(this));
        }
