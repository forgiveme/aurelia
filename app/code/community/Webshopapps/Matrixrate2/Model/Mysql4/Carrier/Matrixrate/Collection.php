...
*/
class Webshopapps_Matrixrate2_Model_Mysql4_Carrier_Matrixrate_Collection extends Varien_Data_Collection_Db
{
    ...
    public function __construct()
    {
        ...
        $this->_shipTable = Mage::getSingleton('core/resource')->getTableName('matrixrate2_shipping/matrixrate');
