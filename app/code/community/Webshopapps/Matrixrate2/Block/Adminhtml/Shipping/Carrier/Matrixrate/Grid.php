...
class Webshopapps_Matrixrate2_Block_Adminhtml_Shipping_Carrier_Matrixrate_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  /**
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('logged_in', array(
            'header'    => Mage::helper('adminhtml')->__('logged in'),
            'index'     => 'logged_in',
        ));
   ...
   protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('matrixrate2_shipping/carrier_matrixrate_collection');
