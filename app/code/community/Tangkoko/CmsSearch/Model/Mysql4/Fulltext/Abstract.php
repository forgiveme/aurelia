 ...
 **/
abstract class Tangkoko_CmsSearch_Model_Mysql4_Fulltext_Abstract extends Mage_Core_Model_Mysql4_Abstract
{
	/**
	 ...
	 */
    abstract protected function _getSearchableElements($storeId, $ids = null, $lastId = 0, $limit = 100);
