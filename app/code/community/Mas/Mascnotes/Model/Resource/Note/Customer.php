 ...
 * 
 */
class Mas_Mascnotes_Model_Resource_Note_Customer extends Mage_Core_Model_Resource_Db_Abstract{
/**
	...
	protected function  _construct(){
		$this->_init('mascnotes/note_customer', 'rel_id');
	}
	/**
	 ...
	 * @param array $data
	 * @return Mas_Mascnotes_Model_Resource_Note_Customer
	 * 
	 */
