...
class As_Custom_Helper_Data extends Mage_Core_Helper_Abstract
{
		public function setCurrentUrl()
		{
				if(!Mage::getSingleton('customer/session')->isLoggedIn()){
						...
						{		$currentUrl = $this->helper('core/url')->getCurrentUrl();
								Mage::getSingleton('core/session')->setAfterLoginUrl($currentUrl);
						}
				}
		}
		...
		public function getCurrentUrl()
		{
			...
			return Mage::getSingleton('core/session')->getAfterLoginUrl();
		...
		{
			$r=(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') 
