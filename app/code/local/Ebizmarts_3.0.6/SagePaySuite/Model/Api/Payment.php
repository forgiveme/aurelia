...
class Ebizmarts_SagePaySuite_Model_Api_Payment extends Mage_Payment_Model_Method_Cc {
    ...
    protected $MD = NULL;
    private $_sharedConf = array('sync_mode', 'email_on_invoice', 'trncurrency', 'referrer_id', 'vendor',
        'timeout_message', 'connection_timeout', 'send_basket', 'sagefifty_basket',
        'surcharge_creditcards', 'basket_format');
