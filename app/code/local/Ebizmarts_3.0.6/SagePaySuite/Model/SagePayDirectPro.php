...
class Ebizmarts_SagePaySuite_Model_SagePayDirectPro extends Ebizmarts_SagePaySuite_Model_Api_Payment {
    ...
    protected function _setRequestCurrencyAmount($request, $quote) {
        ...
        $resource->loadActive($quote2, $quote->getId());*/
        ...
        if ($trnCurrency == 'store') {
            ...
            $request->setAmount($this->formatAmount($quote2->getGrandTotal()-$this->_getSessionSurcharge(), Mage::app()->getStore()->getCurrentCurrencyCode()));
            $request->setCurrency(Mage::app()->getStore()->getCurrentCurrencyCode());
        }
        else {
