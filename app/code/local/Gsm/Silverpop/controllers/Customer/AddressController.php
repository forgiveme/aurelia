<?php
/**
 * Silverpop Customer address controller overrides
 *
 * @category	 Silverpop
...
class Gsm_Silverpop_Customer_AddressController extends Mage_Customer_AddressController {
			...
			if ($this->getRequest()->isPost()) {
				...
				try {
					...
					if (count($errors) === 0) {
						...
						$silverpop->updateRegisteredAccount($customer);
