$(document).ready(function() {
    ...
    $(".tip-blurb-more-q2-answer1").click(function() {

        $("#q2-answer1 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q2-answer2").click(function() {

        $("#q2-answer2 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q2-answer3").click(function() {

        $("#q2-answer3 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q2-answer4").click(function() {

        $("#q2-answer4 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q2-answer5").click(function() {

        $("#q2-answer5 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q3-answer1").click(function() {

        $("#q3-answer1 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q3-answer2").click(function() {

        $("#q3-answer2 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q3-answer3").click(function() {

        $("#q3-answer3 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q4-answer1").click(function() {

        $("#q4-answer1 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q4-answer2").click(function() {

        $("#q4-answer2 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q4-answer3").click(function() {

        $("#q4-answer3 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q4-answer4").click(function() {

        $("#q4-answer4 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q6-answer1").click(function() {

        $("#q6-answer-container").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q7-answer1").click(function() {

        $("#q7-answer1 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q7-answer2").click(function() {

        $("#q7-answer2 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q7-answer3").click(function() {

        $("#q7-answer3 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q7-answer4").click(function() {

        $("#q7-answer4 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q8-answer1").click(function() {

        $("#q8-answer1 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q8-answer2").click(function() {

        $("#q8-answer2 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q8-answer3").click(function() {

        $("#q8-answer3 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q8-answer4").click(function() {

        $("#q8-answer4 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q8-answer5").click(function() {

        $("#q8-answer5 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q9-answer1").click(function() {

        $("#q9-answer1 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q9-answer2").click(function() {

        $("#q9-answer2 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q9-answer3").click(function() {

        $("#q9-answer3 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q11-answer1").click(function() {

        $("#q11-answer1 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q11-answer2").click(function() {

        $("#q11-answer2 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q11-answer3").click(function() {

        $("#q11-answer3 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q12-answer1").click(function() {

        $("#q12-answer-container").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q13-answer1").click(function() {

        $("#q13-answer1 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q13-answer2").click(function() {

        $("#q13-answer2 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q13-answer3").click(function() {

        $("#q13-answer3 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q14-answer1").click(function() {

        $("#q14-answer1 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q14-answer2").click(function() {

        $("#q14-answer2 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $(".tip-blurb-more-q14-answer3").click(function() {

        $("#q14-answer3 .tip-content").toggle(
            "slide", {
                direction: 'up',
                duration: 'slow',
                easing: 'easeOutQuart'
    ...
    $("#page_4").click(function() {
        ...
        console.log($("#feelingslider").slider("value"));
    ...
    $("#feelingslider").slider({
        ...
        slide: function(event, ui) {
            ...
            if (ui.value > 50) {
                $('#feelingslider span.ui-slider-handle.ui-state-default.ui-corner-all').css('background-image', 'url(img/pages/page4/slider_button.png)');
            } else {
