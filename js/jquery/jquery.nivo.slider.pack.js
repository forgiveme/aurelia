(function (a) {
    var b = function (b, c) {
        ...
        if (a(g[e.currentSlide]).is("img")) e.currentImage = a(g[e.currentSlide]);
        else e.currentImage = a(g[e.currentSlide]).find("img:first"); if (a(g[e.currentSlide]).is("a")) a(g[e.currentSlide]).css("display", "block");
        f.css("background",
        ...
        var h = function (b) {
            ...
            if (e.currentImage.attr("title") != "" && e.currentImage.attr("title") != undefined) {
                ...
                if (c.css("opacity") != 0) c.find("p").stop().fadeTo(b.animSpeed, 0, function () {
                        a(this).html(d);
                        a(this).stop().fadeTo(b.animSpeed,
                            1)
                    });
                else c.find("p").html(d);
                c.stop().fadeTo(b.animSpeed, b.captionOpacity)
            } else c.stop().fadeTo(b.animSpeed, 0)
        };
        h(d);
        var i = 0;
        if (!d.manualAdvance && g.length > 1) i = setInterval(function () {
                o(f, g, d, false)
            }, d.pauseTime);
        if (d.directionNav) {
        ...
        if (d.controlNav) {
            ...
            for (var k = 0; k < g.length; k++) if (d.controlNavThumbs) {
                    var l = g.eq(k);
                    if (!l.is("img")) l = l.find("img:first");
                    if (d.controlNavThumbsFromRel) j.append('<a class="nivo-control" rel="' +
                            k + '"><img src="' + l.attr("rel") + '" alt="" /></a>');
                    else j.append('<a class="nivo-control" rel="' + k + '"><img src="' + l.attr("src").replace(d.controlNavThumbsSearch, d.controlNavThumbsReplace) + '" alt="" /></a>')
                } else j.append('<a class="nivo-control" rel="' + k + '">' + (k + 1) + "</a>");
        ...
        if (d.keyboardNav) a(window).keypress(function (a) {
                if (a.keyCode == "37") {
                    if (e.running) return false;
                    clearInterval(i);
                    i = "";
        ...
        if (d.pauseOnHover) f.hover(function () {
                e.paused = true;
                clearInterval(i);
                i = ""
            }, function () {
                e.paused = false;
                if (i == "" && !d.manualAdvance) i = setInterval(function () {
                        o(f,
                            g, d, false)
                    }, d.pauseTime)
            });
        f.bind("nivo:animFinished", function () {
            e.running = false;
            a(g).each(function () {
                if (a(this).is("a")) a(this).css("display", "none")
            });
            if (a(g[e.currentSlide]).is("a")) a(g[e.currentSlide]).css("display", "block");
            if (i == "" && !e.paused && !d.manualAdvance) i = setInterval(function () {
                    o(f, g, d, false)
                }, d.pauseTime);
        ...
        var m = function (b, c, d) {
            for (var e = 0; e < c.slices; e++) {
                ...
                if (e == c.slices - 1) b.append(a('<div class="nivo-slice"></div>').css({
                        left: f * e + "px",
                ...
                else b.append(a('<div class="nivo-slice"></div>').css({
                        left: f * e + "px",
                        width: f + "px",
                        height: "0px",
                        opacity: "0",
        ...
        var n = function (b, c, d) {
            ...
            for (var g = 0; g < c.boxRows; g++) for (var h = 0; h < c.boxCols; h++) if (h == c.boxCols -
                        1) b.append(a('<div class="nivo-box"></div>').css({
                            opacity: 0,
                            left: e * h + "px",
                            top: f * g + "px",
                    ...
                    else b.append(a('<div class="nivo-box"></div>').css({
                            opacity: 0,
                            left: e * h + "px",
                            top: f * g + "px",
                            width: e + "px",
        ...
        var o = function (b, c, d, e) {
            ...
            if (f && f.currentSlide ==
                f.totalSlides - 1) d.lastSlide.call(this);
            if ((!f || f.stop) && !e) return false;
            d.beforeChange.call(this);
            if (!e) b.css("background", 'url("' + f.currentImage.attr("src") + '") no-repeat');
            else {
                if (e == "prev") b.css("background", 'url("' + f.currentImage.attr("src") + '") no-repeat');
            ...
            if (a(c[f.currentSlide]).is("img")) f.currentImage =
                    a(c[f.currentSlide]);
            else f.currentImage = a(c[f.currentSlide]).find("img:first"); if (d.controlNav) {
            ...
            if (g == "sliceDown" || g == "sliceDownRight" || g == "sliceDownLeft") {
                ...
                l.each(function () {
                    ...
                    if (k == d.slices - 1) setTimeout(function () {
                            c.animate({
                                height: "100%",
                                opacity: "1.0"
                ...
                l.each(function () {
                    ...
                    if (k == 0) {
                        ...
                        c.css("bottom", "0px");
                        k = 0
                    } if (o == d.slices - 1) setTimeout(function () {
                            c.animate({
                                height: "100%",
                                opacity: "1.0"
                            }, d.animSpeed, "", function () {
                ...
                v[t] = new Array;
                var s = a(".nivo-box", b);
                if (g == "boxRainReverse" || g == "boxRainGrowReverse") s = a(".nivo-box", b)._reverse();
                s.each(function () {
                    v[t][u] = a(this);
                    u++;
                    if (u == d.boxCols) {
