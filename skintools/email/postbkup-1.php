...
include("../admin/config/db.php");
	...
	if($insid!='' && $row_cnt > 0) {
		...
		$stmt = $conn->prepare("INSERT INTO skintools_emails (address, questiondata_id) VALUES (?, ?)");
		$stmt->bind_param("ss", $useremail, $insid);
	}
    ...
    $img1 = "http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/productimages_200x250_cleanser.jpg";
    $img1_link = "http://aureliacare.newsoftdemo.info/index.php/products/aurelia-miracle-cleanser";
    ...
    $img2 = "http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/productimages_200x250_exfoliator.jpg";
    $img2_link = "http://aureliacare.newsoftdemo.info/index.php/products/refine-and-polish-miracle-balm";
    ...
    $img3 = "http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/productimages_200x250_serum.jpg";
    $img3_link = "http://aureliacare.newsoftdemo.info/index.php/products/revitalise-and-glow-serum";
    ...
    $img4 = "http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/productimages_200x250_day.jpg";
    $img4_link = "http://aureliacare.newsoftdemo.info/index.php/products/cell-revitalise-day-moisturiser";
    ...
    $img5 = "http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/productimages_200x250_night.jpg";
    $img5_link = "http://aureliacare.newsoftdemo.info/index.php/products/cell-revitalise-night-moisturiser";
    ...
    $img6 = "http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/productimages_200x250_nightoil.jpg";
    $img6_link = "http://aureliacare.newsoftdemo.info/index.php/products/cell-repair-night-oil";
    ...
    $img8 = "http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/productimages_200x250_rose.jpg";
    $img8_link = "http://aureliacare.newsoftdemo.info/index.php/products/cell-revitalise-rose-mask";
    ...
    $top_logo = "http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/email/top.png";
    $bg_image = "http://aureliacare.newsoftdemo.info/skin/frontend/default/star-aurelia-responsive/images/bg-tile.jpg";
    $buy_logo = "http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/10off.png";
    $musthave_t = "";
    $musthave_p = "";
    $musthave_img = "";
    $recommended_t = "";
        ...
        <tr>
            <td style="">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
                    <tr>
                        <td align="center" bgcolor="#fff" style="padding: 10px 0 0px 0; color: #706f6f; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
                        <img src="http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/resultsemail_header.jpg">
                        </td>
                    </tr>
                    <tr>
                                            ...
                                            <tr>
                                                <td width="260" valign="top">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td>
                                                                <img src="http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/pages/_all/musthave_2.png" alt="" width="200" height="51" style="display: block;margin-left: auto;     margin-right: auto;" />
                                                ...
                                                <td width="260" valign="top">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td>
                                                                <img src="http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/pages/_all/recommended_2.png" alt="" width="200" height="51" style="display: block;margin-left: auto;     margin-right: auto;" />
                                ...
                                <table style="width:100%; text-align:center;">
                                    <tr>
                                        <td>
                                            ...
                                            <a href="' . $recommended_img_m_link . '">
                                                <img src="http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/10off.png" width="168" height="60" style="display: block; text-align:center; margin-left:auto;margin-right:auto;" />
                                            </a>
                                        </td>
                                        <td>
                                            <p id="musthave_data">
                    ...
                    <tr>
                        <td bgcolor="#fff" style="">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #706f6f; font-family: Arial, sans-serif; text-align:center;" width="100%">
                                        <img src="http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/morehelp.png">
                                        ...
                                        <a href="http://aureliacare.newsoftdemo.info/">
                                        <img src="http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/backto.png">
                                        <img src="http://v8dz4vcugc4yuu5i7c2x.wallacetestbed.co.uk/img/product/resultsemail_footer_2.jpg">
                                        </a>
                                    </td>
                                </tr>
                            </table>
...
';
    ...
    $headers .= 'From:Aurelia <no-reply@AureliaSkincareTool.com' . "\r\n";
